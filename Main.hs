...
mane :: Mane -> IO ()
mane (FindDevice True) = findFPGADevice >>= USB.getDeviceDesc.fst >>= print
mane (ReadJedec True) = printJedecID
mane (ToggleReset True) = toggleReset
mane (Program file) = progFlash file
mane _ = return ()
